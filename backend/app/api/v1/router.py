...
# 公共 iperf3 服务器列表为公开数据，无需认证
api_router.include_router(iperf_public.router, prefix="/iperf", tags=["iperf"])
...
# 组织 Zabbix 级联查询：/organizations/{org_id}/zabbix/hosts、/organizations/{org_id}/zabbix/items
api_router.include_router(zabbix.org_zabbix_router, dependencies=_auth)
